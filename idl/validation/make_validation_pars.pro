...
;	ODir = RooTDir + '/out/validation/'
	ODir = '/home/jmejia/LyaRT/out/validation/'

	Test_HomSlab	= 1				; Homogeneous Slab
	Test_HomSphere	= 1				; Homogeneous Sphere
	Test_NScat		= 0				; Number of scatterings from an homogeneous slab
	Test_fesc_slab	= 0				; f_esc from a dusty homogeneous slab
	Test_ExpSphere	= 0				; Expanding sphere
	Test_ThinShell  = 0				; An homogeneous thin shell
